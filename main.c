...
int main() {
    ...
    switch (userChoice) {
        case 1:
            ...
            break;
        case 2:
            openGoogleMapsLink("https://www.google.com/maps?opi=89978449&rlz=1C1CHBF_enPH991PH991&sca_esv=560909571&lqi=ChJwYXJraW5nIGxvdCBiYWd1aW9I-Zuc8KOugIAIWiYQABABGAAYARgCIhJwYXJraW5nIGxvdCBiYWd1aW8qBggDEAAQAZIBFHB1YmxpY19wYXJraW5nX3NwYWNlqgFMEAEqDyILcGFya2luZyBsb3QoADIfEAEiGwfoZzXzCIrA5GD98zwspUFr8ww7O_twcC96nDIWEAIiEnBhcmtpbmcgbG90IGJhZ3Vpbw&vet=12ahUKEwiziJCfpIGBAxU34jgGHYjGBbMQ8UF6BAgaED8..i&lei=25XtZPOuHLfE4-EPiI2XmAs&cs=0&um=1&ie=UTF-8&fb=1&gl=ph&sa=X&geocode=KZ0C7dtpoZEzMTpCSFiwsdYv&daddr=CH5W%2BHJV,+Camp+John+Hay,+Baguio,+Benguet");
            break;
        case 3:
